...
namespace Tcc.Buffs.Artifacts
{
    public class Lavawalker: ArtifactSet
    {
        ...
        static readonly FirstPassModifier MODIFIER_2PC = (_) => new GeneralStats(elementalResistance: new KeyedPercentBonus<Element>(Element.PYRO, 0.4));
        static readonly EnemyBasedModifier MODIFIER_4PC = (data) => data.enemy.HasAura(Aura.PYRO) ? new GeneralStats(damagePercent: 0.35) : new GeneralStats();
