...
namespace Tcc.Buffs.Artifacts
{
    public class HeartOfDepth: ArtifactSet
    {
        ...
        static readonly FirstPassModifier MODIFIER_2PC = (_) => new GeneralStats(damagePercent: 0.15);
        static readonly AbilityModifier MODIFIER_4PC = (_) => new GeneralStats(damagePercent: 0.3);
        ...
        public override void Add4pc(World world, Unit unit)
        {
            unit.skillActivatedHook += (_, timestamp)
                => unit.AddBuff(new RefreshableBuff<AbilityModifier>(ID_4PC, timestamp + 15, MODIFIER_4PC), Stats.Types.NORMAL, Stats.Types.CHARGED);
        }
    }
}
