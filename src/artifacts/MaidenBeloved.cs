...
namespace Tcc.Buffs.Artifacts
{
    public class MaidenBeloved: ArtifactSet
    {
        ...
        static readonly FirstPassModifier MODIFIER_2PC = (_) => (Stats.Stats.HealingBonus, 0.15);
        static readonly FirstPassModifier MODIFIER_4PC = (_) => (Stats.Stats.IncomingHealingBonus, 0.2);
