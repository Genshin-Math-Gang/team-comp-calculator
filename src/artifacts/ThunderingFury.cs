...
namespace Tcc.Buffs.Artifacts
{
    public class ThunderingFury: ArtifactSet
    {
        ...
        static readonly FirstPassModifier MODIFIER_2PC = (_) => (Stats.Stats.ElectroDamageBonus, 0.15);
        ...
        static readonly FirstPassModifier MODIFIER_4PC = (_) => new StatsPage(new Dictionary<Stats.Stats, double>
        {
            ...
            {Stats.Stats.SuperconductBonus, 0.4},
            {Stats.Stats.ElectrochargedBonus, 0.4}
        });
